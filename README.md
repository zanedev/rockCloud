...
[![Build Status](https://travis-ci.org/rissem/rockcloud.svg?branch=master)](https://travis-ci.org/rissem/rockcloud) [![Dependency Status](https://david-dm.org/rissem/rockcloud.svg)](https://david-dm.org/rissem/rockcloud) [![devDependency Status](https://david-dm.org/rissem/rockcloud.svg)](https://david-dm.org/rissem/rockcloud#info=devDependencies)
...
## Release History
 * 2014-04-30   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)